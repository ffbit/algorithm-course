...
import com.ffbit.week1.quickfind.Find;

public abstract class FindTest {
    ...
    @Test
    public void itShouldNotBeConnectedTransitiveThoughUnitedUnions()
            throws Exception {
        find.union(1, 2);
        ...
        assertFalse(find.connected(0, 4));
    }

    public abstract Find getFind(int capacity);
